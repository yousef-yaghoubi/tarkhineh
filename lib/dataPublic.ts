...
export const navStats = [
  ...
  },
  {
    ...
    route: '/branches',
    subMain: [
      // { id: 1, label: 'شعبه', route: '/branches' },
      { id: 2, label: 'ونک', routeQuery: '/branches/vanak' },
      { id: 3, label: 'اکباتان', routeQuery: '/branches/ekbatan' },
      { id: 4, label: 'چالوس', routeQuery: '/branches/chaloos' },
      { id: 5, label: 'اقدسیه', routeQuery: '/branches/aghdasie' },
    ],
    icon: 'IconNavBranch',
  },
  {
