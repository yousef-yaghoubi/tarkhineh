...
function Button({
  ...
  if(btn == 'fill'){
    return (
      <button
        className={`duration-300 disabled:bg-gray-3 disabled:text-gray-4 ${theme === 'Primary' ? 'bg-primary text-white hover:bg-shade-2 selection:bg-shade-3' : theme === 'White' ? 'bg-tint-1 text-primary hover:bg-tint-2' : 'bg-gray-7 text-white hover:bg-gray-8'} md:w-[184px] md:h-10 rounded-sm md:rounded-md flex items-center justify-center relative ${btnSize}`}
