...
function SwiperMain({
  ...
  return (
    ...
    >
      ...
      >
        <i
          className={`next cursor-pointer !w-6 !h-6 md:!w-12 md:!h-12 absolute left-4`}
        >
          <IconLeft />
        </i>
      </div>
        ...
        >
          <div className={`w-full h-full flex justify-center items-center`}>
            ...
            <Image
              ...
              fill
              priority={index == 0}
              sizes="(max-width: 1280px) 100vw, 1px"
      ...
      <span
        className={`swiper-pagination !w-[82px] h-[19px] bg-[url(/image/Rectangle2Mobile.webp)] dark:bg-[url(/image/Rectangle2MobileDark.webp)] md:!w-[154px] md:h-7 md:bg-[url(/image/Rectangle2.webp)] dark:md:bg-[url(/image/Rectangle2Dark.webp)] mx-auto inset-x-0 absolute !bottom-0 justify-center items-center ${
