...
//   const [isHover, setIsHover] = React.useState(false);
  return (
    <div id={id} className={`w-16 h-16 md:w-24 md:h-24 group flex justify-center items-center rounded border ${isHover == id ? 'border-primary shadow-bank-primary' : 'border-gray-4'}`} onClick={()=> setIsHover(id as string)}>
