...
function Address({
  ...
  return (
    <div
      className={`min-w-72 md:min-w-80 w-full h-fit p-4 cursor-pointer rounded border ${order.delivery.type == 'delivery' && order.delivery.address == prop.address ? 'border-primary' : 'border-gray-4 dark:border-background-2'} bg-gray-3 dark:bg-background-2 flex flex-col relative`}
      onClick={() => {
