...
function SwiperDeatail({ address, images, phones, durition }: Details) {
  return (
    <div className="w-full flex flex-col items-center relative h-[14.2em] md:h-[27.2em]">
      ...
      <div className="w-11/12 max-w-80 h-[60px] md:max-w-[810px] md:h-[130px] md:top-[303px] top-[166px] rounded-sm border md:border-[3px] border-primary bg-white absolute z-20 p-1 md:px-2 grid grid-cols-2 md:grid-cols-3 dark:bg-background-2 dark:text-gray-4">
