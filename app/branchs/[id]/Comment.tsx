...
function Comment() {
  ...
  return (
    <div className="w-[252px] h-[142px] rounded-sm border border-gray-4 relative">
      <div className="w-full h-full py-5 px-4 flex justify-between">
        <div className='!w-[60px] flex flex-col'>
            <Image src={'/image/profile.jpg'} alt='profile' width={56} height={56} className='rounded-full !w-14 !h-14'/>
            <div className='flex flex-col text-gray-7'>
                <span className='caption-sm'>یوسف یعقوبی</span>
                <span className='caption-sm'>{convertToPersianNumbers(date)}</span>
            </div>
        </div>
        <p className='caption-sm w-[152px] my-[6px]'>
      ...
      <div className="flex items-center absolute bottom-[7px] left-4">
        <svg
          width="12"
          height="12"
          viewBox="0 0 16 17"
