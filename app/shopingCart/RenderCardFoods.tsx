    ...
    <>
      {cart.length == 0 ? (
        ...
        <>
          ...
          <aside className="w-11/12 max-w-[704px] xl:max-w-[496px] h-[323px] hidden md:flex md:flex-col mt-10 xl:mt-0 border border-gray-4 dark:border-background-2 rounded-md p-6 text-gray-8 dark:text-gray-1">
              ...
              {cart.map((food)=> (
                <div className='w-full flex justify-between px-2 items-center even:bg-gray-3 bg-gray-1 dark:bg-background-1 odd:dark:bg-background-2 h-14'>
                  <div className='flex flex-col'>
                    ...
                    <span className='caption-sm text-gray-7 dark:text-gray-5'><Price price={food.price} order={food.order}/></span>
                  </div>
                  <QuantityFood id={food.id} quantity={food.quantity}/>
                </div>
              ))}
            </div>
            <aside className="w-full flex flex-col mt-3 text-gray-8 dark:text-gray-1">
